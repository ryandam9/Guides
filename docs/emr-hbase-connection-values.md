...
```xml
  <property>
    ...
    <value>thrift://ip-10-0-1-23.ec2.internal:9083</value>   ← the whole string
...
> metastore, there is no 9083 endpoint — the giveaway is
> `hive.metastore.client.factory.class` containing
